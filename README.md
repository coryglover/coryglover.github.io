...
<div style="display: flex; gap: 20px; align-items: flex-start;  background-color:rgb(139, 228, 228);box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 10px; margin-bottom: 30px;">
