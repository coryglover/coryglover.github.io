 ...
 <div style="padding: 20px;">
    <div style="display: flex; align-items: center; gap: 20px;">
     <!-- Image -->
      ...
      <!-- Text -->
      <p style="margin: 0;">
        PageRank is a common algorithm used to rank vertex importance in a graph. We customize PageRank by toggling the amount of backtracking occurring in its underlying random walk. By letting the probability of backtracking go to 1, we introduce &infin;-PageRank which can be calculated without approximation. Using &infin;-PageRank, we develop a new community detection algorithm.
      </p>
    </div>
  </div>
</div>
